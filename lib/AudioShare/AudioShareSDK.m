...
-(BOOL) hasAudioShare {
	...
	return [[UIApplication sharedApplication] canOpenURL:asURL];
}
...
- (BOOL)initiateSoundImport {
    ...
    if(![[UIApplication sharedApplication] canOpenURL:asURL]) {
		...
		if(!hasAudio) {
			UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"How to Import Audio"
																					 message:@"There are several ways to import audio into Koala. Press \"See How\" to see some instructions of how to do this"
																			  preferredStyle:UIAlertControllerStyleAlert];
			
			UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Cancel", @"Cancel action")
																   style:UIAlertActionStyleDefault
																 handler:^(UIAlertAction *action){}];
//			UIAlertAction *openFilesAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Open Files.app", @"Open files action")
//																   style:UIAlertActionStyleCancel
//																 handler:^(UIAlertAction *action){
//
//																 }];
//
			UIAlertAction *okAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"See How", @"OK action")
															   style:UIAlertActionStyleDefault
															 handler:^(UIAlertAction *action)
									   {
										   [AudioShare openURL:[NSURL URLWithString:@"https://www.elf-audio.com/koala/help/import-audio-how-to.php"]];
									   }];
			
			[alertController addAction:cancelAction];
//			[alertController addAction:openFilesAction];
			[alertController addAction:okAction];

			[AudioShare showAlertController:alertController];
			return NO;
		} else {
			UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Audio Pasted"
																					 message:@""
																			  preferredStyle:UIAlertControllerStyleAlert];
			UIAlertAction *okAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"OK", @"OK action")
															   style:UIAlertActionStyleDefault
