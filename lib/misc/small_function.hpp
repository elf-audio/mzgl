/**
 * Part of the clog library, MIT license
 * 
 * https://github.com/colugomusic/clog/
 * 
 * From https://github.com/colugomusic/clog/blob/master/include/clog/small_function.hpp
 */
#pragma once
...
template <typename Signature, size_t MaxSize = 128>
