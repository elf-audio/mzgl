...
public:
	...
	void print() { YGNodePrint(node, (YGPrintOptions) (YGPrintOptionsLayout | YGPrintOptionsStyle | YGPrintOptionsChildren)); }
	YGNodeRef node;
...
public:
	...
	static void setAttributes(LayoutNodeRef l, const LayoutAttributeList &attrs) { setAttributes(l.get(), attrs); }
