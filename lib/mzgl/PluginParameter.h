...
public:
    ...
    void beginIgnoringAutomation() {
        ignoreAutomation.store(true);
    }
    
    void endIgnoringAutomation() {
        ignoreAutomation.store(false);
    }
    
    bool isIgnoringAutomation() {
        return ignoreAutomation.load();
    }
