...
public:
	SelectionLayer(Graphics &g) : Layer(g) {
...
- (NSView *)outlineView:(NSOutlineView *)outlineView viewForTableColumn:(NSTableColumn *)tableColumn item:(id)item {
	...
	NSTableCellView *v = [[SCTableCellView alloc] initWithFrame: CGRectMake(0, 0, 100, 100)];//[outlineView makeViewWithIdentifier:NSUserInterfaceItemIdentifier(@"Layer") owner:self];
...
void LayerExplorer::show() {
	...
	dispatch_async(dispatch_get_main_queue(), ^{
		...
		window = [[NSWindow alloc]
								...
								styleMask:NSTitledWindowMask | NSWindowStyleMaskResizable backing:NSBackingStoreBuffered defer:NO];
		...
		browser = [[NSOutlineView alloc] initWithFrame:NSMakeRect(0, 0,
