...
public:
	...
	void setup(TextureRef tex) {
		...
		vbo->setIndices({0,	 1, 5,	5,	4, 0,  1,  2,  6,  6, 5,  1,  2,  3,  6,  3,  7, 6, 4,
						 5,	 9, 9,	8,	4, 5,  6,  10, 10, 9, 5,  6,  7,  11, 11, 10, 6, 8, 9,
						 12, 9, 13, 12, 9, 10, 14, 14, 13, 9, 10, 11, 15, 15, 14, 10
