...
void Drawer::drawTriangle(glm::vec2 a, glm::vec2 b, glm::vec2 c) {
	...
	geom.verts.push_back(a);
	geom.verts.push_back(b);
	geom.verts.push_back(c);
	geom.indices.push_back(s);
	geom.indices.push_back(s + 1);
	geom.indices.push_back(s + 2);
...
void Drawer::drawTriangle(glm::vec2 a, glm::vec2 b, glm::vec2 c, glm::vec4 ca, glm::vec4 cb, glm::vec4 cc) {
	...
	geom.indices.push_back(s + 1);
	geom.indices.push_back(s + 2);
	geom.cols.push_back(ca);
	geom.cols.push_back(cb);
	geom.cols.push_back(cc);
}
