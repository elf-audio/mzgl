...
/*
    ...
    Cmdline:
        sokol-shdc --reflection --input lib/mzgl/lib/mzgl/gl/api/sokol/shaders/colorTexture.glsl --output lib/mzgl/lib/mzgl/gl/api/sokol/xcodeShaders/colorTexture.glsl.h --slang glsl300es:hlsl5:metal_macos:metal_ios
