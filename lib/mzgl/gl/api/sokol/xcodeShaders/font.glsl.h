...
/*
    ...
    Cmdline:
        sokol-shdc --reflection --input lib/mzgl/lib/mzgl/gl/api/sokol/shaders/font.glsl --output lib/mzgl/lib/mzgl/gl/api/sokol/xcodeShaders/font.glsl.h --slang glsl300es:hlsl5:metal_macos:metal_ios
