...
/*
    ...
    Cmdline:
        sokol-shdc --reflection --input lib/mzgl/lib/mzgl/gl/api/sokol/shaders/color.glsl --output lib/mzgl/lib/mzgl/gl/api/sokol/xcodeShaders/color.glsl.h --slang glsl300es:hlsl5:metal_macos:metal_ios
