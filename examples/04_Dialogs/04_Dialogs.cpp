...
public:
    Button(Graphics &g, const std::string &name) : Layer(g, name) {
        interactive = true;
    }
...
public:
    ...
    Dialogs dialogs;
    MyApp(Graphics &g) : App(g), dialogs(*this) {
        ...
        alertButton->released = [this]() {
            dialogs.alert("TITLE", "MESSAGE");
        };


        twoOptionCancelButton->released = [this]() {
            dialogs.twoOptionCancelDialog("TITLE", "MSG",
                                   "BUTTON ONE", [this](){dialogs.alert("", "button one pressed");},
                                   "BUTTON TWO", [this](){dialogs.alert("", "button two pressed");},
        ...
        root->addChildren({alertButton, twoOptionCancelButton, chooseImageButton, shareButton, loadButton, launchUrlButton});
